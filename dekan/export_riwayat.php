...
<head>
    ...
    <title>Laporan Peminjaman Dekan</title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="header">
        <h1>Laporan Riwayat Peminjaman Fakultas <?= htmlspecialchars($fakultas_admin) ?></h1>
        <p>Aplikasi Manajemen SIFASKA - Dicetak pada: <?= date('d M Y H:i') ?></p>
    </div>
